export const environment = {
  ...
  api: {
    ...
    googleTranslate: {
      ...
      apiKey: '', // Set via environment variables in production
      enabled: false
    }
  },
  ...
  privacy: {
    ...
    forceHttps: true // HTTPS required in production
  },
  ...
  features: {
    ...
    userAccounts: false,
    analytics: false // Keep disabled for privacy
  },
  ...
  debug: {
    ...
    logSpeechEvents: false,
    logTranslationEvents: false,
    logTtsEvents: false
  },
